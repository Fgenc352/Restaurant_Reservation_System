...
class Restaurant:
    def _init_(self, name, table_num, reservation_info):
        self.name = name
...
class Table:
    def _init_(self, name, is_available="Y", customer_name="", customer_number=""):
        self.name = name
...
class GUI(Frame):
    ...
    def bind_combobox(self, event):  # control combobox binds.
